    ...
    <div class="container">
        <nav class="navbar navbar-expand-md bg-primary navbar-dark fixed-top"> 
            ...
            <a href="index.php" class="navbar-brand logotipo">
                <img src="img/logo.png" class="rounded" alt="Logotipo Lanchonete" />
            </a>
        ...
        <div id="home">
            <h3>Bem vindo ao sistema da Lanchonete</h3>            
            <p>Neste sistema você pode cadastrar lanches, bebidas, 
                acompanhamentos e combos. </p>
